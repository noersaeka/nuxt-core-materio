...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'analytics-news': RouteRecordInfo<'analytics-news', '/analytics/news', Record<never, never>, Record<never, never>>,
    ...
    'mis-analytics-news': RouteRecordInfo<'mis-analytics-news', '/mis-analytics/news', Record<never, never>, Record<never, never>>,
