...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, setCookie, appendHeader, parseCookies, getHeaders, getMethod, getQuery as getQuery$1, isMethod, readBody, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/h3/dist/index.mjs';
import is from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/@sindresorhus/is/dist/index.js';
import destr, { destr as destr$1 } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/destr/dist/index.mjs';
import CredentialsProvider from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/next-auth/providers/credentials.js';
import { ensurePrefix } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/@antfu/utils/dist/index.mjs';
import { AuthHandler } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/next-auth/core/index.js';
import { getToken as getToken$1 } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/next-auth/jwt/index.js';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/defu/dist/defu.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/ufo/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/unctx/dist/index.mjs';
import getURL from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/requrl/dist/requrl.js';
import { version, unref } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/noersa.eka/Development/Playground/nuxt-core-materio/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/noersa.eka/Development/Playground/nuxt-core-materio","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/noersa.eka/Development/Playground/nuxt-core-materio/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/noersa.eka/Development/Playground/nuxt-core-materio/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/noersa.eka/Development/Playground/nuxt-core-materio/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/noersa.eka/Development/Playground/nuxt-core-materio/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _EyaPLmgWg3 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/noersa.eka/Development/Playground/nuxt-core-materio";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _xJIRLlRCms = (nitroApp) => {
...
const _M8CvscOAmZ = defineNitroPlugin(() => {
  try {
    getServerOrigin();
  } catch (error) {
    {
...
const _GpCvv9UQLL = defineNitroPlugin$1((nitroApp) => {
...
const _lazy_Enpd1c = () => Promise.resolve().then(function () { return index$3; });
const _lazy_aYYqNW = () => Promise.resolve().then(function () { return courseDetails_get$1; });
const _lazy_ZVL9Eu = () => Promise.resolve().then(function () { return courses_get$1; });
const _lazy_jMMN7z = () => Promise.resolve().then(function () { return _id__delete$9; });
const _lazy_DlnHaN = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_mzAvgI = () => Promise.resolve().then(function () { return index_get$p; });
const _lazy_YJMD5B = () => Promise.resolve().then(function () { return index_post$5; });
const _lazy_PRyfI0 = () => Promise.resolve().then(function () { return chatsAndContacts_get$1; });
const _lazy_d1QxnP = () => Promise.resolve().then(function () { return _id__get$7; });
const _lazy_MNS0zo = () => Promise.resolve().then(function () { return _id__post$1; });
const _lazy_KMtRqs = () => Promise.resolve().then(function () { return _id__get$5; });
const _lazy_JJcLXm = () => Promise.resolve().then(function () { return index_get$n; });
const _lazy_Dkf6E0 = () => Promise.resolve().then(function () { return _id__delete$7; });
const _lazy_J2qbpK = () => Promise.resolve().then(function () { return index_get$l; });
const _lazy_8NzUU7 = () => Promise.resolve().then(function () { return index_get$j; });
const _lazy_AGEjL6 = () => Promise.resolve().then(function () { return index_get$h; });
const _lazy_Q4s9nb = () => Promise.resolve().then(function () { return _id__delete$5; });
const _lazy_18wbBb = () => Promise.resolve().then(function () { return index_get$f; });
const _lazy_DfBZLJ = () => Promise.resolve().then(function () { return index_get$d; });
const _lazy_upisAV = () => Promise.resolve().then(function () { return index_post$3; });
const _lazy_5U6yJ8 = () => Promise.resolve().then(function () { return _id__delete$3; });
const _lazy_16VeWx = () => Promise.resolve().then(function () { return _id__get$3; });
const _lazy_w4yX2R = () => Promise.resolve().then(function () { return clients_get$1; });
const _lazy_G1uud2 = () => Promise.resolve().then(function () { return index_get$b; });
const _lazy_DGjJcP = () => Promise.resolve().then(function () { return index$1; });
const _lazy_lGNiBz = () => Promise.resolve().then(function () { return index_get$9; });
const _lazy_kC8FT0 = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_RCrOFT = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_CQH1zy = () => Promise.resolve().then(function () { return index_get$7; });
const _lazy_iuFlkq = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_G0DDEP = () => Promise.resolve().then(function () { return _____$1; });
const _lazy_mkFfDw = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_rUA102 = () => Promise.resolve().then(function () { return me_get$1; });
const _lazy_656aj6 = () => Promise.resolve().then(function () { return datatable_get$1; });
const _lazy_9Aa8B4 = () => Promise.resolve().then(function () { return faq_get$1; });
const _lazy_E7Fr6U = () => Promise.resolve().then(function () { return index_get$5; });
const _lazy_R2Kyzm = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_JD7OzA = () => Promise.resolve().then(function () { return header_get$1; });
const _lazy_4kod1b = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_dPFKTf = () => Promise.resolve().then(function () { return token_get$1; });
const _lazy_Bhd2UR = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/app-bar/search', handler: _lazy_Enpd1c, lazy: true, middleware: false, method: undefined },
  { route: '/api/apps/academy/course-details', handler: _lazy_aYYqNW, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/academy/courses', handler: _lazy_ZVL9Eu, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/calendar/:id', handler: _lazy_jMMN7z, lazy: true, middleware: false, method: "delete" },
  { route: '/api/apps/calendar/:id', handler: _lazy_DlnHaN, lazy: true, middleware: false, method: "put" },
  { route: '/api/apps/calendar', handler: _lazy_mzAvgI, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/calendar', handler: _lazy_YJMD5B, lazy: true, middleware: false, method: "post" },
  { route: '/api/apps/chat/chats-and-contacts', handler: _lazy_PRyfI0, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/chat/chats/:id', handler: _lazy_d1QxnP, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/chat/chats/:id', handler: _lazy_MNS0zo, lazy: true, middleware: false, method: "post" },
  { route: '/api/apps/ecommerce/customers/:id', handler: _lazy_KMtRqs, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/ecommerce/customers', handler: _lazy_JJcLXm, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/ecommerce/orders/:id', handler: _lazy_Dkf6E0, lazy: true, middleware: false, method: "delete" },
  { route: '/api/apps/ecommerce/orders', handler: _lazy_J2qbpK, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/ecommerce/products', handler: _lazy_8NzUU7, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/ecommerce/referrals', handler: _lazy_AGEjL6, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/ecommerce/reviews/:id', handler: _lazy_Q4s9nb, lazy: true, middleware: false, method: "delete" },
  { route: '/api/apps/ecommerce/reviews', handler: _lazy_18wbBb, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/email', handler: _lazy_DfBZLJ, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/email', handler: _lazy_upisAV, lazy: true, middleware: false, method: "post" },
  { route: '/api/apps/invoice/:id', handler: _lazy_5U6yJ8, lazy: true, middleware: false, method: "delete" },
  { route: '/api/apps/invoice/:id', handler: _lazy_16VeWx, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/invoice/clients', handler: _lazy_w4yX2R, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/invoice', handler: _lazy_G1uud2, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/logistics/vehicles', handler: _lazy_DGjJcP, lazy: true, middleware: false, method: undefined },
  { route: '/api/apps/permissions', handler: _lazy_lGNiBz, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/users/:id', handler: _lazy_kC8FT0, lazy: true, middleware: false, method: "delete" },
  { route: '/api/apps/users/:id', handler: _lazy_RCrOFT, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/users', handler: _lazy_CQH1zy, lazy: true, middleware: false, method: "get" },
  { route: '/api/apps/users', handler: _lazy_iuFlkq, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/**', handler: _lazy_G0DDEP, lazy: true, middleware: false, method: undefined },
  { route: '/api/login', handler: _lazy_mkFfDw, lazy: true, middleware: false, method: "post" },
  { route: '/api/me', handler: _lazy_rUA102, lazy: true, middleware: false, method: "get" },
  { route: '/api/pages/datatable', handler: _lazy_656aj6, lazy: true, middleware: false, method: "get" },
  { route: '/api/pages/faq', handler: _lazy_9Aa8B4, lazy: true, middleware: false, method: "get" },
  { route: '/api/pages/help-center/article', handler: _lazy_E7Fr6U, lazy: true, middleware: false, method: "get" },
  { route: '/api/pages/help-center', handler: _lazy_R2Kyzm, lazy: true, middleware: false, method: "get" },
  { route: '/api/pages/profile/header', handler: _lazy_JD7OzA, lazy: true, middleware: false, method: "get" },
  { route: '/api/pages/profile', handler: _lazy_4kod1b, lazy: true, middleware: false, method: "get" },
  { route: '/api/token', handler: _lazy_dPFKTf, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_Bhd2UR, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Bhd2UR, lazy: true, middleware: false, method: undefined }
];
...
const _id__delete$8 = defineEventHandler((event) => {
  ...
  const eventIndex = db$b.events.findIndex((e) => Number(e.id) === eventId);
...
const _id__put = defineEventHandler(async (event) => {
  ...
  const currentEvent = db$b.events.find((e) => e.id === updatedEvent.id);
  if (currentEvent) {
...
const index_get$o = defineEventHandler((event) => {
  ...
  const events = db$b.events.filter((e) => calendars == null ? void 0 : calendars.includes(e.extendedProps.calendar));
  setResponseStatus(event, 200);
  return events;
});
...
const chatsAndContacts_get = defineEventHandler(async (event) => {
  ...
  const chatsContacts = db$a.chats.map((chat) => {
    const contact = JSON.parse(JSON.stringify(db$a.contacts.find((c) => c.id === chat.userId)));
  ...
  return {
    ...
    contacts: db$a.contacts.filter((c) => c.fullName.toLowerCase().includes(qLowered)),
...
const _id__get$6 = defineEventHandler(async (event) => {
  ...
  const chat = db$a.chats.find((c) => c.userId === userId);
  if (chat)
    chat.unseenMsgs = 0;
  return {
    chat,
    contact: db$a.contacts.find((c) => c.id === userId)
  };
});
...
const _id__get$4 = defineEventHandler((event) => {
  ...
  const customerIndex = db$9.customerData.findIndex((e) => e.customerId === id);
...
const _id__delete$6 = defineEventHandler((event) => {
  ...
  const orderIndex = db$9.orderData.findIndex((e) => e.id === id);
  if (orderIndex >= 0) {
...
const _id__delete$4 = defineEventHandler((event) => {
  ...
  const reviewIndex = db$9.reviews.findIndex((e) => e.id === id);
  if (reviewIndex >= 0) {
...
const db$8 = {
  emails: [
    ...
    },
    {
      id: 46,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "crussell@hotmail.com", name: "Alexa Burnett", avatar: avatar4$3 },
    ...
    },
    {
      id: 45,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "kkim@yahoo.com", name: "Dominique Paul", avatar: avatar4$3 },
      ...
      replies: [
        ...
        },
        {
          id: 8,
          to: [{ email: "johndoe@mail.com", name: "me" }],
          from: { email: "lmoreno@yahoo.com", name: "Ashley Lewis", avatar: avatar4$3 },
    ...
    },
    {
      id: 43,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "rmartin@gmail.com", name: "Nicole Allen", avatar: avatar4$3 },
    ...
    },
    {
      id: 42,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "adkinsryan@yahoo.com", name: "Karen Russell", avatar: avatar6$3 },
      ...
      replies: [
        ...
        },
        {
          id: 600,
          to: [{ email: "johndoe@mail.com", name: "me" }],
          from: { email: "mary98@yahoo.com", name: "Dana Harvey", avatar: avatar2$4 },
    ...
    },
    {
      id: 41,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "julie16@yahoo.com", name: "Tyler Hernandez", avatar: avatar3$3 },
    ...
    },
    {
      id: 40,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "brownsandy@gmail.com", name: "Michael Smith", avatar: avatar3$3 },
    ...
    },
    {
      id: 39,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "marissa73@hotmail.com", name: "James Russell", avatar: avatar3$3 },
    ...
    },
    {
      id: 37,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "juliasosa@hotmail.com", name: "Cheryl Wright", avatar: avatar6$3 },
    ...
    },
    {
      id: 36,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "benjamin30@gmail.com", name: "Pamela Mueller", avatar: avatar6$3 },
    ...
    },
    {
      id: 35,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "dana33@yahoo.com", name: "Becky Coffey", avatar: avatar2$4 },
    ...
    },
    {
      ...
      replies: [
        ...
        },
        {
          id: 930166,
          to: [{ email: "johndoe@mail.com", name: "me" }],
          from: { email: "nramirez@yahoo.com", name: "Kenneth West", avatar: avatar1$4 },
    ...
    },
    {
      id: 30,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "kempsarah@gmail.com", name: "Sherry Guzman", avatar: avatar2$4 },
    ...
    },
    {
      id: 29,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "daniel37@hotmail.com", name: "David Cruz", avatar: avatar5$3 },
    ...
    },
    {
      id: 28,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "areeves@gmail.com", name: "Anthony Obrien", avatar: avatar5$3 },
    ...
    },
    {
      id: 27,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "bnunez@hotmail.com", name: "Jason Gonzalez", avatar: avatar5$3 },
    ...
    },
    {
      id: 25,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "fullerkatelyn@hotmail.com", name: "Ana Short", avatar: avatar4$3 },
    ...
    },
    {
      id: 24,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "hmoran@gmail.com", name: "Vincent Alexander", avatar: avatar1$4 },
      ...
      replies: [
        ...
        },
        {
          id: 19865651,
          to: [{ email: "johndoe@mail.com", name: "me" }],
          from: { email: "danny06@gmail.com", name: "Walter Moss", avatar: avatar3$3 },
    ...
    },
    {
      id: 21,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "bakercarrie@yahoo.com", name: "Dawn Hall", avatar: avatar2$4 },
    ...
    },
    {
      ...
      replies: [
        ...
        },
        {
          id: 18,
          to: [{ email: "johndoe@mail.com", name: "me" }],
          from: { email: "dwelch@yahoo.com", name: "Peter Davis", avatar: avatar1$4 },
        ...
        },
        {
          id: 712,
          to: [{ email: "johndoe@mail.com", name: "me" }],
          from: { email: "larrybrown@yahoo.com", name: "Amy Peters", avatar: avatar4$3 },
    ...
    },
    {
      id: 15,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "dreed@hotmail.com", name: "Rhonda Hamilton", avatar: avatar4$3 },
    ...
    },
    {
      id: 12,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "ugray@gmail.com", name: "Jane Buckley", avatar: avatar2$4 },
    ...
    },
    {
      id: 10,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "sean36@gmail.com", name: "Ronald Buckley", avatar: avatar5$3 },
    ...
    },
    {
      id: 9,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "wkline@yahoo.com", name: "Jennifer Garcia", avatar: avatar6$3 },
    ...
    },
    {
      id: 8,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "tolson@gmail.com", name: "Lindsey Melton", avatar: avatar2$4 },
    ...
    },
    {
      id: 7,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "jeffrey89@gmail.com", name: "Amanda Pratt", avatar: avatar4$3 },
    ...
    },
    {
      id: 6,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "gentryjeff@yahoo.com", name: "Joseph Clark", avatar: avatar3$3 },
    ...
    },
    {
      id: 3,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "gbeltran@gmail.com", name: "Charles Cooper", avatar: avatar1$4 },
    ...
    },
    {
      id: 1,
      to: [{ email: "johndoe@mail.com", name: "me" }],
      from: { email: "edavid@yahoo.com", name: "Wendy Harris", avatar: avatar2$4 },
...
const index_get$c = defineEventHandler((event) => {
  ...
  const emailsMeta = {
    ...
    draft: db$8.emails.filter((email) => email.folder === "draft").length,
...
const index_get$a = defineEventHandler((event) => {
  ...
  let filteredInvoices = database.filter((invoice) => (invoice.client.name.toLowerCase().includes(queryLowered) || invoice.client.companyEmail.toLowerCase().includes(queryLowered) || invoice.id.toString().includes(queryLowered)) && invoice.invoiceStatus === (status || invoice.invoiceStatus)).reverse();
  if (sortByLocal) {
...
const index = defineEventHandler((event) => {
  ...
  if (sortByLocal && sortByLocal === "location") {
    db$7.vehicles = db$7.vehicles.sort((a, b) => {
      if (orderByLocal === "asc")
  ...
  return { vehicles: paginateArray(db$7.vehicles, itemsPerPageLocal, pageLocal), totalVehicles: db$7.vehicles.length };
});
...
const index_get$8 = defineCachedEventHandler((event) => {
  ...
  const searchQuery = is.string(q) ? q : void 0;
  const queryLower = (searchQuery != null ? searchQuery : "").toString().toLowerCase();
  let filteredPermissions = db$6.permissions.filter((permissions) => permissions.name.toLowerCase().includes(queryLower) || permissions.createdDate.toLowerCase().includes(queryLower) || permissions.assignedTo.some((i) => i.toLowerCase().startsWith(queryLower)));
...
const _id__delete = defineEventHandler((event) => {
  ...
  const userIndex = db$5.users.findIndex((user) => user.id === userId);
...
const _id__get = defineEventHandler((event) => {
  ...
  const user = db$5.users.find((u) => u.id === userId);
  if (!user) {
    throw createError({
      statusCode: 404,
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s - Media Inteligence System","title":"MIS"};
...
const getClientManifest = () => import('file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/noersa.eka/Development/Playground/nuxt-core-materio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
