...
<template>
  <VCard>
    <VCardItem title="News By Source" subtitle="Total number of source 139">
      <template #append>
        <div class="me-n3">
          <MoreBtn />
        </div>
    ...
    <VCardText>
      <VueApexCharts id="shipment-statistics" height="320" :options="shipmentConfig" :series="series" />
    </VCardText>
  </VCard>
</template>
